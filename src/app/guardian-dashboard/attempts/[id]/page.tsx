'use client';
// src/app/guardian-dashboard/attempts/[id]/page.tsx
...
export default function GuardianAttemptReviewPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background" dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-6 py-8">
        <AttemptReviewView
          attemptId={attemptId}
          fetchUrl={`/api/guardian/attempts/${attemptId}`}
          lang={lang}
          font={font}
          backLabel={isRtl ? 'العودة لمتابعة الطالب' : 'Back to Dashboard'}
